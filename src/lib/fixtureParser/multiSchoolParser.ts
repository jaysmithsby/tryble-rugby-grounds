...
function parseFixtureLine(
  ...
  // Compute venue type and ID — always "school", pointing to the ground where the match is played
  const venueType: "school" | "tournament" = "school";
